...
class SavePolygonValidator:
    ...
    def __init__(self, polygon_dao: PolygonRepository):
        self.dao = polygon_dao
    ...
    def is_valid_polygon(self, polygon: List[str]) -> bool:
        ...
        return self.dao.is_closed_polygon(polygon)

    def is_name_taken(self, name: str) -> bool:
        result = self.dao.find_by_name(name)
        if result is None:
            return False
        return True
